...
// these are generated by ANTLR from the lexer and parser grammars
import { StartlangLexer } from '../parser/StartlangLexer';
import { StartlangParser } from '../parser/StartlangParser';
import { StartlangParserVisitor } from '../parser/StartlangParserVisitor';
...
function buildNode(type, attrs, options = {}) {
...
function makeVisitor() {
  // the visitor must be an instance of StartlangParserVisitor, or else
  // the parser will traverse the tree differently
  return Object.assign(new StartlangParserVisitor(), {
    visitProg(ctx) {
...
export function parse(input) {
  ...
  return parser.prog().accept(makeVisitor());
}
