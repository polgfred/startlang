...
Blockly.Msg.MATH_ONLIST_TOOLTIP_SORT_ASC =
  'Sort the items in the list from smallest to largest.';
Blockly.Msg.MATH_ONLIST_TOOLTIP_SORT_DESC =
  'Sort the items in the list from largest to smallest.';
Blockly.Msg.MATH_ONLIST_TOOLTIP_REVERSE =
  'Reverse the positions of the items in the list.';
Blockly.Msg.MATH_ONLIST_TOOLTIP_SHUFFLE =
  'Shuffle the items of the list into a random order.';
...
Blockly.Msg.TABLES_CREATE_WITH_TOOLTIP =
  'Create a table with any number of keys and values.';
...
Blockly.Msg.TABLES_CREATE_WITH_CONTAINER_TOOLTIP =
  'Add or remove sections to reconfigure this table block.';
...
Blockly.Msg.TABLES_GET_INDEX_TOOLTIP_GET =
  'Returns the item for the specified key in a table.';
Blockly.Msg.TABLES_GET_INDEX_TOOLTIP_GET_REMOVE =
  'Removes and returns the item for the specified key in a table.';
Blockly.Msg.TABLES_GET_INDEX_TOOLTIP_REMOVE =
  'Removes the item for the specified key in a table.';
...
Blockly.Msg.TABLES_SET_INDEX_TOOLTIP =
  'Sets the item for the specified key in a table.';
