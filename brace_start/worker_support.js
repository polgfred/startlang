var lang = exports.lang = function(exports) {
...
var oop = exports.oop = function(exports) {
 ...
 * @constructor
 **/
var Range = exports.Range = function(startRow, startColumn, endRow, endColumn) {
    this.start = {
        row: startRow,
        column: startColumn
    };
...
var Document = exports.Document = function(text) {
    this.$lines = [];
    if (text.length === 0) {
        this.$lines = [""];
