  ...
  constructor() {
    ...
    this.$rules = {
      start: [
        {
          token: 'keyword',
          regex: /\b(?:and|b(egin|reak|y)|do|e(lse|nd|xit)|f(or|rom)|i[fn]|let|n(ext|ot)|or|t(hen|o)|re(peat|turn)|w(hile|ith))\b/
        }, {
          ...
          token: 'support.function',
          regex: /\b(?:c(ircle|lone)|display|ellipse|f(ill|lip(x|y))|line|move|opacity|poly(gon|line)|r(e(ct|fresh|move|paint)|otate)|s(cale(x|y)?|kew(x|y)|troke)|translate)\b/
        }, {
