  ...
  constructor() {
    ...
    this.$rules = {
      start: [
        {
          token: 'keyword',
          regex: /\b(?:and|b(egin|reak|y)|count|do|e(lse|nd)|f(or|rom)|i[fn]|let|n(ext|ot)|or|t(hen|o)|return|w(hile|ith))\b/
        }, {
          token: 'constant.language',
          regex: /\b(?:false|infinity|none|true)\b/
        }, {
          token: 'support.function',
          regex: /\b(?:a(bs|cos|dd|sin|tan|vg)|c(eil|lamp|o(py|s))|diff|e(ndof|x(it|p))|f(irst|loor)|in(pu|ser)t|join|keys|l(ast|en|ist|o(g|wer))|m(ax|in)|num|p(art|ow|rint|ut)|r(and|e(mov|plac|vers)e|gb|ound|sort)|s(huffle|in|leep|ort|plit|qrt|t(artof|r)|u(b|m)|wap)|t(a(ble|n)|ime)|upper)\b/
        }, {
          token: 'support.function',
