...
function rawTextPlugin(extension: string): Plugin {
  return {
    name: `startlang-raw-${extension.slice(1)}`,
    ...
    alias: [
      {
        ...
        replacement: path.resolve(rootDir, '../../packages/lang-core/src'),
      },
      {
        find: '@startlang/lang-browser',
        replacement: path.resolve(rootDir, '../../packages/lang-browser/src'),
      },
    ],
  },
  server: {
